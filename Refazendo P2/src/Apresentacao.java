...
public class Apresentacao extends javax.swing.JFrame {
    ...
    private void jBCadastrarAlunoActionPerformed(java.awt.event.ActionEvent evt) {
    	if (jTFNomeDoAluno.getText()==null) {
    		throw new IllegalArgumentException("Aluno sem nome");
    	}
    	if (atual==null) {
    	Aluno a = new Aluno(jTFNomeDoAluno.getText(), null);
    	atual = a;
    	String msg="Aluno cadastrado";
    	JOptionPane.showMessageDialog(this,msg);
    	}
    	else {
    		estudantes.add(atual);
    		Aluno a = new Aluno(jTFNomeDoAluno.getText(), null);
        	atual = a;
        	String msg="Aluno cadastrado";
        	JOptionPane.showMessageDialog(this,msg);
    ...
    private void jBIncluirAvaliacaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBIncluirAvaliacaoActionPerformed
    	Avaliacao a; //declara uma avaliacao no começo e define que tipo depois, big brain
    	if (jTFDescricao.getText()==null) {
    		throw new IllegalArgumentException("Descrição nula");
    	}
    	if (jRBTrabalho.isSelected()) {
    		a = new Trabalho(jTFDescricao.getText(), jTFNotaConceito.getText().charAt(0));
    		atual.addAvaliacao(a);
    		String msg="Trabalho resgistrado";
        	JOptionPane.showMessageDialog(this,msg);
    	}
    	else {
    		if (jRBProva.isSelected()) {
    			String sas = jTFNotaConceito.getText();
    			float nota = Float.parseFloat(sas);
    			a = new Prova((String)jTFDescricao.getText(), nota);
        		atual.addAvaliacao(a);
        		String msg="Prova cadastrada";
            	JOptionPane.showMessageDialog(this,msg);
    		}
    	}
    ...
    private void jBEmitirBoletinsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBEmitirBoletinsActionPerformed
    	jTABoletins.setText("----------------------------------------\n");
    	for (Aluno a : this.estudantes) {
    		jTABoletins.append(a.exibeBoletim() + "\n\n----------------------------------------\n");
    	}
